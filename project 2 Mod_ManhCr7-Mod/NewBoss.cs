...
{
	public static Image shadowBig = mSystem.M1071("/mainImage/shadowBig.png");
	...
	public new static Image imgHP = mSystem.M1071("/mainImage/myTexture2dmobHP.png");
	...
	private void M1160(mGraphics g)
	{
	...
	public void M1168(Char[] cAttack, int[] dame, sbyte type, sbyte dir)
	{
		charAttack = cAttack;
		dameHP = dame;
		this.type = type;
	...
	public void M1169()
	{
		...
		if (tick == frameArr[15][type - 1])
		{
			for (int i = 0; i < charAttack.Length; i++)
			{
				...
				ServerEffect.M1571(frameArr[16][type - 1], charAttack[i].cx, charAttack[i].cy, 1);
			}
		}
	}
	...
	public override void paint(mGraphics g)
	{
		if (Mob.arrMobTemplate[templateId].data != null)
		{
			...
			Mob.arrMobTemplate[templateId].data.M401(g, frame, x, y + fy, (dir != 1) ? 1 : 0, 2);
			g.M918(0, -GameCanvas.transY);
	...
	public void M1175(Mob mobToAttack)
	{
