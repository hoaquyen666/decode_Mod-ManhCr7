public class Arrowpaint
{
	...
	public void M9(mGraphics g)
	{
		int num = M10(Res.M1511(axTo - ax, -(ayTo - ay)));
		SmallImage.M1785(g, imgId[FRAME[num]], ax, ay, TRANSFORM[num], mGraphics.VCENTER | mGraphics.HCENTER);
	}
