public class Arrow
{
	...
	public void M5(mGraphics g)
	{
		int num = M6(Res.M1511(axTo - ax, -(ayTo - ay)));
		SmallImage.M1785(g, arrp.imgId[FRAME[num]], ax, ay, TRANSFORM[num], mGraphics.VCENTER | mGraphics.HCENTER);
	}
