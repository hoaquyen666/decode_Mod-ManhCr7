...
public class NinjaUtil
{
	...
	public void M1183()
	{
		GameCanvas.M490(mResources.downloading_data);
	}

	public static int M1184(int max)
	{
		return new MyRandom().M1084(max);
	}

	public static sbyte[] M1185(Message msg)
	{
		try
		{
		...
		{
			Cout.M328("LOI DOC readByteArray NINJAUTIL");
		}
		return null;
	}

	public static sbyte[] M1186(myReader dos)
	{
		try
		{
		...
		{
			Cout.M328("LOI DOC readByteArray dos  NINJAUTIL");
		}
		return null;
	}
