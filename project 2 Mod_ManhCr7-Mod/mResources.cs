public class mResources
{
	...
	public static void loadLanguague(sbyte newLanguage)
	{
		...
		{
		case 0:
			LoginScr.imgTitle = GameCanvas.M503("/mainImage/logo1.png");
			T1.M1882();
			ServerListScreen.linkweb = "https://www.facebook.com/zmanhcr7";
			break;
		case 1:
			LoginScr.imgTitle = GameCanvas.M503("/mainImage/logo1E.png");
			T2.M1883();
	...
	{
		return NinjaUtil.M1187(str, "#", replacement);
	}
}
