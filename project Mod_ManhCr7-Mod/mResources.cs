public class mResources
{
	...
	public static void loadLanguague(sbyte newLanguage)
	{
		...
		{
		case 0:
			T90.imgTitle = T51.M503("/mainImage/logo1.png");
			T164.M1882();
			T144.linkweb = "https://www.facebook.com/zmanhcr7";
			break;
		case 1:
			T90.imgTitle = T51.M503("/mainImage/logo1E.png");
			T165.M1883();
			T144.linkweb = "http://world.teamobi.com";
			break;
		case 2:
			T90.imgTitle = T51.M503("/mainImage/logo1E.png");
			T166.M1884();
			T144.linkweb = "http://dragonball.indonaga.com";
			break;
		}
	}
	...
	{
		return T122.M1187(str, "#", replacement);
	}
}
