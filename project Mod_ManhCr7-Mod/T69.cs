public class T69
{
	...
	public T117 vecInfo = new T117("vecInfo chientruong");

	public T69(int type_PB, short idmapPaint, string nameTeam1, string nameTeam2, int maxPoint, short timeSecond)
	{
	...
	public void M763(int type_PB, short timeSecond)
	{
		this.type_PB = type_PB;
		this.timeSecond = timeSecond;
		timeStart = T51.timeNow;
	...
	public void M764(int type_PB, int pointTeam1, int pointTeam2)
	{
		this.type_PB = type_PB;
	...
	public void M765(int type_PB, int lifeTeam1, int lifeTeam2)
	{
		this.type_PB = type_PB;
