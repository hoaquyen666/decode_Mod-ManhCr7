public class T163
{
	public static int TOP_CENTER = T99.TOP | T99.HCENTER;

	public static int TOP_LEFT = T99.TOP | T99.LEFT;

	public static int TOP_RIGHT = T99.TOP | T99.RIGHT;

	public static int BOTTOM_HCENTER = T99.BOTTOM | T99.HCENTER;

	public static int BOTTOM_LEFT = T99.BOTTOM | T99.LEFT;

	public static int BOTTOM_RIGHT = T99.BOTTOM | T99.RIGHT;

	public static int VCENTER_HCENTER = T99.VCENTER | T99.HCENTER;

	public static int VCENTER_LEFT = T99.VCENTER | T99.LEFT;
