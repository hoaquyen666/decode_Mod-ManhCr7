...
public class T147 : T78
{
	public class T216
	{
		public List<T97> sendingMessage;

		public T216()
		{
			sendingMessage = new List<T97>();
		}

		public void M2317(T97 message)
		{
		...
		public void M2318()
		{
			while (connected)
			{
				try
				{
					...
					{
						T24.M328(ex.ToString());
					}
				}
				catch (Exception)
				{
					T137.M1513("error send message! ");
				}
			}
		}
	}
	...
	private class T217
	{
		...
		private void M2320(T97 message)
		{
			try
			{
				...
				getKeyComplete = true;
				T52.IP2 = message.M887().M1100();
				T52.PORT2 = message.M887().M1094();
				T52.isConnect2 = ((message.M887().M1088() != 0) ? true : false);
				if (isMainSession && T52.isConnect2)
				{
					T51.M450();
				}
			}
	...
	protected static T147 instance = new T147();
	...
	public static T63 messageHandler;
	...
	public static T117 recieveMsg = new T117();
	...
	public void setHandler(T63 msgHandler)
	{
	...
	public void sendMessage(T97 message)
	{
		count++;
		T137.M1513("SEND MSG: " + message.command);
		sender.M2317(message);
	}

	private static void M1747(T97 m)
	{
		sbyte[] array = m.M886();
		try
		{
	...
	public static void M1750(T97 msg)
	{
	...
	public static void M1751()
	{
		...
		{
			T97 t = (T97)recieveMsg.M1114(0);
			if (!T23.isStopReadMessage)
			{
				if (t != null)
				{
